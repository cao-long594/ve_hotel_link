...
/**
 * @author xiaotengyu
 * @since 2023-02-03 14:24
 */
public class ElongSearchPrepayResult {
    ...
    private List<ElongSearchLadderParse> ladderParseList;
    /**
    ...
    public List<ElongSearchLadderParse> getLadderParseList() {
        return ladderParseList;
    }

    public void setLadderParseList(List<ElongSearchLadderParse> ladderParseList) {
